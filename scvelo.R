...
ldata1=scv.read_loom("baso.loom",validate=False)
ldata2=scv.read_loom("baso_2.loom",validate=False)
...
ldata = ldata1.concatenate([ldata1, ldata2])
...
scv.pl.proportions(adata, groupby='celltype_full',save="proportion.pdf")
