...
colnames(splice) <- paste(substring(colnames(splice),5,20),"_1_1",sep="")
colnames(unsplice) <- paste(substring(colnames(unsplice),5,20),"_1_1",sep="")
head(colnames(splice))
head(colnames(unsplice))
x1$spliced<-splice
...
head(colnames(splice))
head(colnames(unsplice))
colnames(splice) <- paste(substring(colnames(splice),6,21),"_1_1",sep="")
colnames(unsplice) <- paste(substring(colnames(unsplice),6,21),"_1_1",sep="")
head(colnames(splice))
head(colnames(unsplice))
x2$spliced<-splice
...
head(colnames(splice))
head(colnames(unsplice))
colnames(splice) <- paste(substring(colnames(splice),6,21),"_2_1",sep="")
colnames(unsplice) <- paste(substring(colnames(unsplice),6,21),"_2_1",sep="")
head(colnames(splice))
head(colnames(unsplice))
x4$spliced<-splice
...
head(colnames(splice))
head(colnames(unsplice))
colnames(splice) <- paste(substring(colnames(splice),7,22),"_1",sep="")
colnames(unsplice) <- paste(substring(colnames(unsplice),7,22),"_1",sep="")
head(colnames(splice))
head(colnames(unsplice))
x5$spliced<-splice
...
#整合reti
spliced <- cbind(x1[["spliced"]], x2[["spliced"]], x4[["spliced"]], x5[["spliced"]], x6[["spliced"]])
unspliced <- cbind(x1[["unspliced"]], x2[["unspliced"]], x4[["unspliced"]], x5[["unspliced"]], x6[["unspliced"]])
#未整合reti
